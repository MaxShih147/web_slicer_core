...
Tolerance compensation adjusts per-layer contour offsets (both outer contour and holes) to counteract dimensional inaccuracies in SLA printing. Separate parameters are provided for general layers and bottom layers.
