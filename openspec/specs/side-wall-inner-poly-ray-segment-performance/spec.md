# side-wall-inner-poly-ray-segment-performance Specification

## Purpose
TBD - created by archiving change perf-side-wall-inner-poly-ray-segment. Update Purpose after archive.
## Requirements
