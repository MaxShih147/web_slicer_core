...
- [x] 1.5 [REQ-DEID-007] Security／Release 審閱 A+B+C′ 必要、C-full／D／E 僅加成（L3）（**2026-07-19 Vance Approve** — [`evidence/signoff-gate5-pending-20260719.md`](./evidence/signoff-gate5-pending-20260719.md)；A–E [`evidence/feasibility-A-E-2.1-20260719.md`](./evidence/feasibility-A-E-2.1-20260719.md)）
...
- [x] 2.1 [REQ-DEID-006/007] 產出 A–E 可行性報告；**C′ 必須可達雙平台 L2**；明確記錄 C-full／OLLVM 為 L3 不做。（**2026-07-19：** [`evidence/feasibility-A-E-2.1-20260719.md`](./evidence/feasibility-A-E-2.1-20260719.md)；雙平台 C′ 由 2.4／2.5＋§7 declare 支撐）
...
- [x] 2.8 評估結論經 Backend Security／Release Engineering 審閱並回寫 `design.md`（**2026-07-19 Vance Approve** — [`evidence/signoff-gate5-pending-20260719.md`](./evidence/signoff-gate5-pending-20260719.md)；已回寫 `design.md`「待產品簽核」§6／§11）
...
- [x] 7.1 [REQ-DEID-002/003/006/010] macOS 各發布 architecture L1+L2 通過（**2026-07-19 DECLARE PASS — arm64（唯一現行發布 arch）** — [`evidence/macos/section7-mac-declare-7.1-20260719.md`](./evidence/macos/section7-mac-declare-7.1-20260719.md)；含 qa three-crash＋7.6＋7.4）
- [x] 7.2 [REQ-DEID-002/003/006/010] Windows x64 L1+L2 通過（**2026-07-19 DECLARE PASS** — [`evidence/windows/section7-win-declare-7.2-20260719.md`](./evidence/windows/section7-win-declare-7.2-20260719.md)）
...
- [x] 7.4 [REQ-DEID-013] macOS post-sign／notarize／staple CI gate 通過（**2026-07-19：** `ci_gate_macos_deid_7.4.sh`＋workflow；DMG `…2111` scan／help／codesign／stapler **PASS** — [`evidence/macos/ci-gate-7.4-20260719T151403Z/SUMMARY.md`](./evidence/macos/ci-gate-7.4-20260719T151403Z/SUMMARY.md)）
- [x] 7.5 [REQ-DEID-013] Windows post-Authenticode CI gate 通過（**2026-07-19：** `ci_gate_windows_deid_7.5.ps1`＋GH workflows；本機 staging＋Setup Authenticode PASS — [`evidence/windows/ci-gate-7.5-20260719T144512Z/SUMMARY.md`](./evidence/windows/ci-gate-7.5-20260719T144512Z/SUMMARY.md)）
- [x] 7.6 [REQ-DEID-014] 雙平台 functional／performance regression 通過（**門檻 2.7 approved**；**Win PASS** — [`evidence/windows/functional-7.6-20260719T143000Z/SUMMARY.md`](./evidence/windows/functional-7.6-20260719T143000Z/SUMMARY.md)；**macOS arm64 PASS** — [`evidence/macos/functional-7.6-20260719/SUMMARY.md`](./evidence/macos/functional-7.6-20260719/SUMMARY.md)；§6 延伸 SHOULD 後補）
- [x] 7.7 [REQ-DEID-010] Evidence metadata、hash、scanner／blacklist version、四方簽核齊備（**2026-07-19 Vance Approve** 四方 — [`evidence/signoff-gate5-pending-20260719.md`](./evidence/signoff-gate5-pending-20260719.md)）

## 8. OpenSpec lifecycle

- [x] 8.1 [REQ-DEID-001] 確認範圍未夾帶前端／UI／安裝流程（[`evidence/scope-8.1-confirmed-20260719.md`](./evidence/scope-8.1-confirmed-20260719.md)）
- [x] 8.2 更新 `traceability.md`，所有 Requirement 均有 Design／Task／Evidence（2026-07-19 夜 union：雙平台 7.6＋Win 7.2／7.5）
- [x] 8.3 執行 `openspec validate backend-slicer-engine-deidentification --strict`（2026-07-17 通過；**2026-07-19 文件對齊後重跑 PASS**）
- [x] 8.4 將 `.openspec.yaml` status 更新為 **`in_progress`**（2026-07-17；M1／2.4 關閉後）。Gate 5 人簽已關；**8.5 promote 已關**；`completed`／archive 見 **8.6**（未做）
- [x] 8.5 完成時將能力 spec promote 至 `openspec/specs/slicer-engine-deidentification/spec.md`（**2026-07-19** — [`../../specs/slicer-engine-deidentification/spec.md`](../../specs/slicer-engine-deidentification/spec.md)）
- [ ] 8.6 將 change archive 至 `openspec/changes/archive/YYYY-MM-DD-backend-slicer-engine-deidentification/`（**未執行**；change 仍留 active）
