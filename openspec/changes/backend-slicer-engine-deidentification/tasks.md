> **進度快照（2026-07-19 夜）：** **Win 7.2 宣告＋7.5 CI gate 已關**；Win 7.6 PASS；2.7 approved。≈**94–96%**。下一步：**mac 7.6**＋**1.5／7.7 人簽**。詳見 [`PROGRESS.md`](./PROGRESS.md)。
## 1. 治理與必要輸入
...
- [ ] 1.5 [REQ-DEID-007] Security／Release 審閱 A+B+C′ 必要、C-full／D／E 僅加成（L3）（**簽核包已備：** [`evidence/signoff-gate5-pending-20260719.md`](./evidence/signoff-gate5-pending-20260719.md)；待人簽）
...
- [ ] 2.1 [REQ-DEID-006/007] 產出 A–E 可行性報告；**C′ 必須可達雙平台 L2**；明確記錄 C-full／OLLVM 為 L3 不做。（**進度：** 雙平台 C′ 可行性已由 **2.4／2.5 PoC** 證明；**書面 A–E 報告**仍缺；併入 1.5／2.8 簽核包）
...
- [ ] 2.8 評估結論經 Backend Security／Release Engineering 審閱並回寫 `design.md`（**簽核包已備** — [`evidence/signoff-gate5-pending-20260719.md`](./evidence/signoff-gate5-pending-20260719.md)；待人簽）
...
- [ ] 7.6 [REQ-DEID-014] 雙平台 functional／performance regression 通過（**門檻 2.7 approved**；**Win 半邊 PASS 2026-07-19** — [`evidence/windows/functional-7.6-20260719T143000Z/SUMMARY.md`](./evidence/windows/functional-7.6-20260719T143000Z/SUMMARY.md)；**mac 半邊仍開**）
- [ ] 7.7 [REQ-DEID-010] Evidence metadata、hash、scanner／blacklist version、四方簽核齊備（**Legal 已關**；其餘簽核包 — [`evidence/signoff-gate5-pending-20260719.md`](./evidence/signoff-gate5-pending-20260719.md)）
...
- [x] 8.2 更新 `traceability.md`，所有 Requirement 均有 Design／Task／Evidence（2026-07-19 夜對齊 Win 7.2／7.5／7.6）
- [x] 8.3 執行 `openspec validate backend-slicer-engine-deidentification --strict`（2026-07-17 通過；**2026-07-19 文件對齊後重跑 PASS**）
- [x] 8.4 將 `.openspec.yaml` status 更新為 **`in_progress`**（2026-07-17；M1／2.4 關閉後）。`completed` 待雙平台 L1+L2＋gates（**仍開：mac 7.6／1.5／7.7**）
- [ ] 8.5 完成時將能力 spec promote 至 `openspec/specs/slicer-engine-deidentification/spec.md`（**blocked on mac §7＋簽核**）
- [ ] 8.6 將 change archive 至 `openspec/changes/archive/YYYY-MM-DD-backend-slicer-engine-deidentification/`（**blocked on mac §7＋簽核**）
